                                        ...
                                        <div class="swiper-container background-img js-swiper-slider"
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img loading="lazy"
                                                        src="{{ secure_asset('assets/images/products/book-product-00.jpg') }}"
                                                        width="330" height="400" alt="" class="pc__img">
                                                </div>
                                                <div class="swiper-slide">
                                                    <img loading="lazy"
                                                        src="{{ secure_asset('assets/images/products/book-product-01.jpg') }}"
                                                        width="330" height="400" alt="" class="pc__img">
                                                </div>
                                            </div>
                                    ...
                                    <div class="pc__img-wrapper">
                                        <div class="swiper-container background-img js-swiper-slider"
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img loading="lazy"
                                                        src="{{ secure_asset('assets/images/products/book-product-10.jpg') }}"
                                                        width="330" height="400" alt="Cropped Faux leather Jacket"
                                                        class="pc__img">
                                                </div>
                                                <div class="swiper-slide">
                                                    <img loading="lazy"
                                                        src="{{ secure_asset('assets/images/products/book-product-11.jpg') }}"
                                                        width="330" height="400" alt="Cropped Faux leather Jacket"
                                                        class="pc__img">
                                                </div>
                                            </div>
