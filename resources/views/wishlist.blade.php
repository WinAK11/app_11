                                    ...
                                    <tr>
                                        <td>
                                            <div class="shopping-cart__product-item">
                                                <img loading="lazy"
                                                    src="{{ Storage::disk('s3')->url('uploads/products/thumbnails/' . $item->model->image) }}"
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-6">
                                                    <form method="post"
                                                        action="{{ route('wishlist.addtocart', ['rowId' => $item->rowId]) }}">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-warning">Add to
                                                            Cart</button>
                                                    </form>
                                                </div>
                                                <div class="col-6">
