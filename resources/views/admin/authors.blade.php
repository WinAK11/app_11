        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('admin.author.add') }}"><i class="icon-plus"></i>Add
                        new</a>
                </div>
                            ...
                            <tbody>
                                @foreach ($authors as $author)
                                    <tr>
                                        ...
                                        <td class="pname">
                                            <div class="image">
                                                <img src="{{ Storage::disk('s3')->url('uploads/authors/' . $author->image) }}"
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                ...
                                                <form action="{{ route('admin.author.delete', ['id' => $author->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
